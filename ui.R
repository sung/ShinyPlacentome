                ...
                fluidPage(
                    sidebarLayout(
                        sidebarPanel(
                            ...
                            # bookmark button
                            bookmarkButton(id="bk_deg_boot")
                        ), # end of sidebarPanel
                        # Show the DEG by Boot
                        mainPanel(
                            tabsetPanel(
                                tabPanel("PE",
                ...
                fluidPage(
                    sidebarLayout(
                        ...
                        #    selectizeInput("deg_genes","Gene Name(s):", choices=gene.names, selected = "FSTL4", multiple=TRUE) # client side
                            ...
                            # bookmark button
                            bookmarkButton(id="bk_deg_genes")
                        ),
                ...
                fluidPage(
                    sidebarLayout(
                        sidebarPanel(
                            ...
                            # bookmark button
                            bookmarkButton(id="bk_deg_ensgs")
                        ),
                        # Show a plot of the generated distribution
                        mainPanel(
                            tabsetPanel(
            ...
            fluidPage(
                sidebarLayout(
                    sidebarPanel(
                        ...
                        # bookmark button
                        bookmarkButton(label="Bookmark This Page...",id="bk_browse_transcript")
                    ),
                    # Show the transcript
                    mainPanel(
                ...
                fluidPage(
                    sidebarLayout(
                        sidebarPanel(
                            ...
                            # bookmark button
                            bookmarkButton(label="Bookmark This Page...",id="bk_pt_specific")
                            # a set of radio buttons - transcript type
                        ),
                        # Show the heatmap
                        mainPanel(
                ...
                fluidPage(
                    sidebarLayout(
                        sidebarPanel(
                            ...
                            # bookmark button
                            bookmarkButton(id="bk_gtex_genes")
                        ),
                        # Show FPKM across the tissue 
                        mainPanel(
                ...
                fluidPage(
                    sidebarLayout(
                        sidebarPanel(
                            ...
                            # bookmark button
                            bookmarkButton(id="bk_not_in_pt")
                        ), # end of sidebarPanel
                        # Show not in placenta result
                        mainPanel(
                            tabsetPanel(
